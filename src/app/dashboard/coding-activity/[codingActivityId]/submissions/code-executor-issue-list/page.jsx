  ...
  const getpythonExecutorIssueListsList = async (page) => {
    ...
    const config = {
      ...
      params: {
        ...
        select: 'user description createdAt',
      },
    };
    setListLoading(true);
    try {
        ...
        <div className="w-full flex justify-end pb-3 -m-1">
          <div className="p-1">
            ...
            >
              ...
              {createLoading ? 'Creating...' : 'New issue'}
            </button>
          </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="inline-flex space-x-1 items-center text-base font-semibold text-white">
                          <Link href={`/dashboard/coding-activity/${params.codingActivityId}/code-executor-issue-list/${item._id}`}>
                            <button
                              type="button"
