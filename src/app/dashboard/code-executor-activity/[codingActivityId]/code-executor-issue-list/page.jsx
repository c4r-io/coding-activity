...
const Page = ({ params }) => {
  ...
  const createSamplePythonExecutorIssueList = async () => {
    ...
    try {
      ...
      router.push(`/dashboard/code-executor-activity/${params.codingActivityId}/code-executor-issue-list/${response.data._id}`);
        ...
        <div className="w-full flex justify-end pb-3 -m-1">
          <div className="p-1">
            ...
            >
              ...
              {createLoading ? 'Creating...' : 'New Python executor issue'}
            </button>
          </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="inline-flex space-x-1 items-center text-base font-semibold text-gray-900 dark:text-white">
                          <Link href={`/dashboard/code-executor-activity/${params.codingActivityId}/code-executor-issue-list/${item._id}`}>
                            <button
                              type="button"
