...
const Page = ({ params }) => {
  ...
  const createSamplePythonExecutorIssueList = async () => {
    ...
    try {
      ...
      router.push(`/dashboard/code-executor-activity/${params.codingActivityId}/chat-feedback/${response.data._id}`);
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="inline-flex space-x-1 items-center text-base font-semibold text-gray-900 dark:text-white">
                          {/* <Link href={`/dashboard/code-executor-activity/${params.codingActivityId}/pythonExecutorIssueList/${item._id}`}>
                            <button
                              type="button"
