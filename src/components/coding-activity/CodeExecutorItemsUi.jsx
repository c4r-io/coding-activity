              ...
              <tbody>
                {videoClipListList?.results?.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">{item?.parentActivity? item?.parentActivity?.activityTitle:"Parent"}</td>
                    <td className="px-6 py-4 text-right">
                      <div className="inline-flex space-x-1 items-center text-base font-semibold text-white">
                        ...
                        <button
                          type="button"
                          className={`edit_button bg-red-500`}
                          onClick={() => {
                            setDeleteList([item._id]); 
                            deleteConfirmDialog(true);}}
                        >
                          {apiDeleteByIdHook.loading ? "Deleting..." : "Delete"}
                        </button>
          ...
          <div className="relative w-full max-w-md max-h-full">
            <div className="relative rounded-lg shadow bg-gray-700">
              <button
                ...
                onClick={() => {setDeletePopup(false); setDeleteList([]);}}
              >
                <svg
                  className="w-3 h-3"
                  aria-hidden="true"
